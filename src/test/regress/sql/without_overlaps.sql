...
INSERT INTO temporal_rng VALUES
  ('[1,1]', daterange('2018-01-02', '2018-02-03')),
  ('[1,1]', daterange('2018-03-03', '2018-04-04')),
  ('[2,2]', daterange('2018-01-01', '2018-01-05')),
  ('[3,3]', daterange('2018-01-01', NULL));

ALTER TABLE temporal_fk_rng2rng
	DROP CONSTRAINT temporal_fk_rng2rng_fk;
INSERT INTO temporal_fk_rng2rng VALUES ('[1,1]', daterange('2018-01-02', '2018-02-01'), '[1,1]');
ALTER TABLE temporal_fk_rng2rng
	ADD CONSTRAINT temporal_fk_rng2rng_fk
	FOREIGN KEY (parent_id, PERIOD valid_at)
	REFERENCES temporal_rng;
ALTER TABLE temporal_fk_rng2rng
	DROP CONSTRAINT temporal_fk_rng2rng_fk;
INSERT INTO temporal_fk_rng2rng VALUES ('[2,2]', daterange('2018-01-02', '2018-04-01'), '[1,1]');
-- should fail:
ALTER TABLE temporal_fk_rng2rng
	ADD CONSTRAINT temporal_fk_rng2rng_fk
	FOREIGN KEY (parent_id, PERIOD valid_at)
...
INSERT INTO temporal_fk_rng2rng VALUES ('[2,2]', daterange('2018-01-02', '2018-04-01'), '[1,1]');
-- now it should work:
INSERT INTO temporal_rng VALUES ('[1,1]', daterange('2018-02-03', '2018-03-03'));
INSERT INTO temporal_fk_rng2rng VALUES ('[2,2]', daterange('2018-01-02', '2018-04-01'), '[1,1]');
...
UPDATE temporal_fk_rng2rng SET valid_at = daterange('2018-01-02', '2018-03-01') WHERE id = '[1,1]';
-- should fail:
UPDATE temporal_fk_rng2rng SET valid_at = daterange('2018-01-02', '2018-05-01') WHERE id = '[1,1]';
...
BEGIN;
  INSERT INTO temporal_rng VALUES
    ('[5,5]', daterange('2018-01-01', '2018-02-01')),
    ('[5,5]', daterange('2018-02-01', '2018-03-01'));
  INSERT INTO temporal_fk_rng2rng VALUES
    ('[3,3]', daterange('2018-01-05', '2018-01-10'), '[5,5]');
  ALTER TABLE temporal_fk_rng2rng
...
INSERT INTO temporal_rng VALUES ('[5,5]', daterange('2018-01-01', '2018-02-01'));
UPDATE temporal_rng SET valid_at = daterange('2016-01-01', '2016-02-01') WHERE id = '[5,5]';
...
INSERT INTO temporal_rng VALUES
  ('[5,5]', daterange('2018-01-01', '2018-02-01')),
  ('[5,5]', daterange('2018-02-01', '2018-03-01'));
INSERT INTO temporal_fk_rng2rng VALUES ('[3,3]', daterange('2018-01-05', '2018-01-10'), '[5,5]');
...
INSERT INTO temporal_rng VALUES
  ...
  ('[5,5]', daterange('2018-02-01', '2018-03-01'));
INSERT INTO temporal_fk_rng2rng VALUES ('[3,3]', daterange('2018-01-05', '2018-01-10'), '[5,5]');
DELETE FROM temporal_rng WHERE id = '[5,5]' AND valid_at = daterange('2018-02-01', '2018-03-01');
-- a PK delete that fails because both are referenced:
DELETE FROM temporal_rng WHERE id = '[5,5]' AND valid_at = daterange('2018-01-01', '2018-02-01');
...
INSERT INTO temporal_fk_rng2rng VALUES ('[4,4]', daterange('2018-01-01', '2021-01-01'), '[6,6]');
ALTER TABLE temporal_fk_rng2rng
	DROP CONSTRAINT temporal_fk_rng2rng_fk,
	ADD CONSTRAINT temporal_fk_rng2rng_fk
		FOREIGN KEY (parent_id, PERIOD valid_at)
...
INSERT INTO temporal_rng VALUES ('[9,9]', daterange('2018-01-01', '2021-01-01'));
INSERT INTO temporal_fk_rng2rng VALUES ('[6,6]', daterange('2018-01-01', '2021-01-01'), '[9,9]');
ALTER TABLE temporal_fk_rng2rng
	DROP CONSTRAINT temporal_fk_rng2rng_fk,
	ADD CONSTRAINT temporal_fk_rng2rng_fk
		FOREIGN KEY (parent_id, PERIOD valid_at)
...
INSERT INTO temporal_rng VALUES ('[12,12]', daterange('2018-01-01', '2021-01-01'));
INSERT INTO temporal_fk_rng2rng VALUES ('[8,8]', daterange('2018-01-01', '2021-01-01'), '[12,12]');
ALTER TABLE temporal_fk_rng2rng
