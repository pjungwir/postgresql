...
is($result, qq{[1,2)|[2000-01-01,2010-01-01)|a}, 'synced temporal_no_key FULL');
...
$node_publisher->safe_psql('postgres',
  "INSERT INTO temporal_unique (id, valid_at, a)
   VALUES ('[1,2)', '[2000-01-01,2010-01-01)', 'a')");
$node_publisher->safe_psql('postgres',
  "UPDATE temporal_unique SET a = 'b'");


# #################################
# Test with REPLICA IDENTITY NONE
# #################################
